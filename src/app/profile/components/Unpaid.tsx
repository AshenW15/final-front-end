    ...
    <div className="flex flex-col w-full bg-white min-h-screen">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center mb-4 border-b">
          ...
          <button className="px-3 py-2 text-red-600 font-medium border-b-2 border-red-600">To pay</button>
          <button className="px-3 py-2 text-black font-medium">To ship</button>
          <button className="px-3 py-2 text-black font-medium">Shipped</button>
        ...
        {/* Pay All Orders Button */}
        <div className="flex items-center space-x-2 mb-6">
          <div className="w-6 h-6 rounded-full border border-gray-300 bg-gray-100"></div>
          <button className="bg-yellow-300 text-yellow-800 px-4 py-2 rounded text-sm font-medium">
            Pay all orders (0)
          </button>
        </div>
